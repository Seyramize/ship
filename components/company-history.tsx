    ...
    <section className="space-y-6">
      <div className="max-w-3xl">
        ...
        <p className="text-muted-foreground mb-4">
          Founded in 2005, GlobalTide Express began as a small regional shipping company with just three trucks and a
        ...
        <p className="text-muted-foreground">
          Today, GlobalTide Express is proud to be a trusted partner to thousands of businesses worldwide, from small
